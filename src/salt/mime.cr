module Salt::Mime
  ...
  def extension(content_type : String) : String?
    ...
    stores.extensions[content_type]?
  end
  ...
  def charset(content_type : String) : String
    ...
    if content_type.includes?("charset")
      _, value = content_type.split("charset", 2)
  ...
  private def stores
    @@stores ||= begin
      ...
      extensions = Hash(String, String).new
  ...
  # :nodoc:
  private record Mapper, types : Hash(String, String), extensions : Hash(String, String)
